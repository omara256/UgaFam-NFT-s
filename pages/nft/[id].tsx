...
//--
    ...
    <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <header className="flex item-center justify-between">
             <h1 className="w-52 cursor-pointer text-xl font-extralight sm:w-80">
                 The{' '} <span className="font-extrabold underline decoration-gray-800/50"> UGAFAM </span>{' '} NFT Market Place
                 
             </h1>

             {/* <button 
                className="rounded-full bg--400 px-4 py-2 text-xs font-bold text-white lg:px-5 lg:py-3 lg:text-base">
  ...
  {address ? 'Connected' : 'Connect with MetaMask'}
        ...
        <button 
        className="h-16 bg-gray-800 text-white w-full rounded-full mt-10 font-bold">
             Mint NFT (0.01 ETH)
        </button>
